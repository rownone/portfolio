    ...
    <section className="resume-section" id="experience">
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
            ...
            <ul>
                ...
                <li>Created and deployed various smart contracts, including Non-Fungible Tokens (NFT), ERC20 Fungible Tokens, Lotteries, Voting systems, Airdrops, and Token Sales on Ethereum and Binance Blockchain networks</li>
                ...
                <li>Designed and implemented Web Scraper add-ons for Firefox browser</li>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
            ...
            <ul>
            <li>Developed web and window-based business projects based on client and system requirements as defined by the Project System Analyst</li>
            <li>Collaborated with teams of 3 to 5 members for each project</li>
            <li>Conducted QA testing for assigned modules</li>
            <li>Created Inquiries and Report modules</li>
