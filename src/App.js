			 ...
			 <section className="resume-section" id="about">
                <div className="resume-section-content">
                    ...
                    <div className="subheading mb-5">
                        B6 L25, Samantha Homes, Bago Gallera Davao City, Philippines · 
                        <a href="mailto:row.none@gmail.com">row.none@gmail.com</a>
                    </div>
                    ...
                    <div className="social-icons">
                        ...
                        <a className="social-icon" href="https://github.com/rownone"><i className="fab fa-github"></i></a>
                        <a className="social-icon" href="https://twitter.com/row_none"><i className="fab fa-twitter"></i></a>
                        <a className="social-icon" href="https://www.facebook.com/ronan.li.14"><i className="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </section>
            <hr className="m-0" />
                ...
                <div className="resume-section-content">
							...
							<div className="d-flex flex-column flex-md-row justify-content-between mb-5">
								...
								<div className="flex-grow-1">
									<ul className="fa-ul mb-0">
										<li>
											<span className="fa-li"><i className="fas fa-check"></i></span>
											<a target="_blank" rel="noreferrer" href="https://realtydao.com">iconsultants.com</a>
										</li>
										<li>
											<span className="fa-li"><i className="fas fa-check"></i></span>
											<a target="_blank" rel="noreferrer" href="https://realtydao.com">musicring.com</a>
										</li>
										<li>
											<span className="fa-li"><i className="fas fa-check"></i></span>
											<a target="_blank" rel="noreferrer" href="https://realtydao.com">venturecamp.com</a>
										</li>
										<li>
											<span className="fa-li"><i className="fas fa-check"></i></span>
											<a target="_blank" rel="noreferrer" href="https://realtydao.com">streamblog.com</a>
										</li>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="flex-grow-1">
                            ...
                            <ul><li>Focused coding in Client Side of the software.</li>
